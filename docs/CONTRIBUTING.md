...
Before participating in the project, please read our [Code of Conduct](https://github.com/bilbilak/packster?tab=coc-ov-file#readme). By engaging with this repository and its respective community, you agree to abide by its terms.

## 💻 Setting up your development environment

1. [Fork](https://github.com/bilbilak/packster/fork) the project on _GitHub_ to your own account.
...
2. Clone your fork to your local development environment:
    ```
    git clone git@github.com:bilbilak/packster.git
    cd bilbilak
    ```
3. Make sure you have the necessary tools installed, such as _Bash_ and any dependencies required by the project.
